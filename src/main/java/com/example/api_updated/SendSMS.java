...
public class SendSMS {
    private static final String ACCOUNT_SID = "ACaae5abda9a0b61d9bc88a9a2c3130fdc";
//    ACaae5abda9a0b61d9bc88a9a2c3130fdc
    private static final String AUTH_TOKEN = "cfad8bf984319e8c4f1df3ea3bb155fc";
//    cfad8bf984319e8c4f1df3ea3bb155fc
    public static String sendSms(String phoneNumber, String message){
        ...
        Message message1 = Message.creator(
                ...
                new com.twilio.type.PhoneNumber("+15076801067"),
                message).create();
